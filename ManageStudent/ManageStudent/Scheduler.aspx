...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" ManageStudent.Model.SchedulerAppointment"
        TypeName=" ManageStudent.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" ManageStudent.Model.SchedulerResource"
        TypeName=" ManageStudent.Model.ResourceDataSourceHelper"
